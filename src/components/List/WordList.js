        ...
        <div className={classes.main}>
          ...
          <div className={classes.container}>
            <List component='ul' className={classes.list} >
              {items.map((item) => (
                <ListItem key={item} component='li' className={classes.item}>
            ...
            {items.map((item) => (
              <div className={classes.itemBox}>
                <div className={classes.btnBox}>
                  <ListItem key={item} component='li' className={classes.btnItem}>
                    <button className={classes.btn} type='button' onClick={() => {onClickDelete(item.id)}}>
                      x
                    </button>
                    <button className={classes.btn} type='button' onClick={() => speak(item.word)}>
                ...
                <div className={classes.listBox}>
                  <ListItem key={item} component='li' className={classes.resItem}>
                    {item.word}
                  </ListItem>
                  <ListItem key={item} component='li' className={classes.resItem}>
                    {item.meaning}
            ...
            {items.map((item) => (
              <div className={classes.itemBox}>
                <div className={classes.minBtnBox}>
                  <ListItem key={item} component='li' className={classes.minBtnItem}>
